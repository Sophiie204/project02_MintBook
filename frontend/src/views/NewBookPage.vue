            ...
            <div id="divide_section">
                <div id="category">
                    ...
                    <ul v-for="tmp of state.categorylist" :key="tmp">
                        <li id="category_list" style="cursor: pointer;" @click="categoryNew(tmp.categoryid)">{{ tmp.categoryname }}</li>
                    </ul>
                </div>
                <div id="booklist">
...
export default {
    ...
    setup () {
        ...
        const load=()=>{
            axios.get('/api/get/new').then(({data})=>{
        ...
        const categoryNew=(e)=>{
            axios.get(`/api/get/new/genre?genre=${e}`).then(({data})=>{
                console.log("categoryNew",data);
                state.item=data;
                state.total=data.totalElements
        ...
        const handlePage=(pageNum)=>{
            axios.get(`/api/get/new?page=${pageNum-1}&size=10`).then(({data})=>{
